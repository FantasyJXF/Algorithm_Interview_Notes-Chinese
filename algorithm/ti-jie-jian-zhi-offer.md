...
* [37. 序列化二叉树（DFS）_\*_](ti-jie-jian-zhi-offer.md#37-序列化二叉树dfs)
...
> \[LeetCode 讨论区\]\([https://leetcode.com/problems/number-of-digit-one/discuss/64381/4+-lines-O\(log-n\)-C++JavaPython](https://leetcode.com/problems/number-of-digit-one/discuss/64381/4+-lines-O%28log-n%29-C++JavaPython)\)
